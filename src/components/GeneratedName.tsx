...
const GeneratedName: React.FC<GeneratedNameProps> = ({ name }) => {
  ...
  return (
    <div className="text-center p-6 bg-slate-900/50 rounded-lg border border-purple-500/20 shadow-inner shadow-purple-900/20">
      ...
      <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-blue-200 mb-2">
        {fullName}
      </p>
      <p className="text-lg italic text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-purple-200">
        {title}
      </p>
    </div>
  );
